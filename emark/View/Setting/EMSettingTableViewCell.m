...
- (void)updateCellWithTitle:(NSString *)title
{
    ...
    self.bottomView.hidden = [title isEqualToString:NSLocalizedString(@"支持一下", nil)];
    if ([title isEqualToString:NSLocalizedString(@"更换头像", nil)]) {
        ...
        self.picImageView.image = [UIImage imageNamed:@"settingHelp"];
    }
    else{
        self.picImageView.image = [UIImage imageNamed:@"settingMore"];
    }
}
