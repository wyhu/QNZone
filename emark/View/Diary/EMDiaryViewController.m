...
- (void)initUI
{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"publishDiary"] style:0 target:self action:@selector(publishDiary)];
