...
- (void)showPointBadgeAtIndex:(NSInteger)index{
    ...
    tabBarButton.badgeValue.type = JMTabBarBadgeValueTypePoint;
}
...
- (void)showNewBadgeAtIndex:(NSInteger)index {
    ...
    tabBarButton.badgeValue.type = JMTabBarBadgeValueTypeNew;
}
...
- (void)showNumberBadgeValue:(NSString *)badgeValue AtIndex:(NSInteger)index {
    ...
    tabBarButton.badgeValue.type = JMTabBarBadgeValueTypeNumber;
}
